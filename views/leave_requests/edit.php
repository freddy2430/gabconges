                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h2 class="mb-1">Modifier Demande de Congé</h2>
                                    <p class="text-muted mb-0">Modifier votre demande en attente</p>
                                </div>
                    ...
                    <div class="request-info mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>Information :</strong> Vous ne pouvez modifier que les demandes en attente d'approbation.
                                Les demandes déjà approuvées ou rejetées ne peuvent pas être modifiées.
                            </div>
                        </div>
                    </div>

                    <!-- Error Messages -->
                    <?php if (isset($_SESSION['edit_request_errors'])): ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <strong>Erreurs de validation :</strong>
                            <ul class="mb-0 mt-2">
                                <?php foreach ($_SESSION['edit_request_errors'] as $error): ?>
                                    <li><?php echo htmlspecialchars($error); ?></li>
                                <?php endforeach; ?>
                            </ul>
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                        <?php unset($_SESSION['edit_request_errors']); ?>
                    <?php endif; ?>

                    <?php if (isset($_SESSION['edit_request_error'])): ?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <?php echo htmlspecialchars($_SESSION['edit_request_error']); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                        <?php unset($_SESSION['edit_request_error']); ?>
                    <?php endif; ?>
                        ...
                        <div class="col-lg-8">
                            <div class="form-card card">
                                <div class="card-body p-4">
                                    <form method="POST" action="index.php?action=leave_request_update" novalidate>
                                            ...
                                            <select class="form-control" id="leave_type_id" name="leave_type_id" required>
                                                ...
                                                <?php foreach ($leaveTypes as $type): ?>
                                                    <option value="<?php echo $type['id']; ?>"
                                                            <?php echo (($request['leave_type_id'] == $type['id']) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="date"
                                                       ...
                                                       id="start_date"
                                                       name="start_date"
                                                       value="<?php echo htmlspecialchars($_SESSION['edit_request_data']['start_date'] ?? $request['start_date']); ?>"
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="date"
                                                       ...
                                                       id="end_date"
                                                       name="end_date"
                                                       value="<?php echo htmlspecialchars($_SESSION['edit_request_data']['end_date'] ?? $request['end_date']); ?>"
                                                       min="<?php echo date('Y-m-d'); ?>"
                                                       required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      name="reason"
                                                      rows="4"
                                                      required><?php echo htmlspecialchars($_SESSION['edit_request_data']['reason'] ?? $request['reason']); ?></textarea>
                                            <div class="form-text">Décrivez les raisons de votre demande</div>
                                            <div class="form-text">
